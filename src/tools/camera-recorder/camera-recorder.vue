...
function refreshCurrentDevices() {
  if (_.isNil(currentCamera.value) || !cameras.value.find(i => i.deviceId === currentCamera.value)) {
    currentCamera.value = cameras.value[0]?.deviceId;
  }

  if (_.isNil(currentMicrophone.value) || !microphones.value.find(i => i.deviceId === currentMicrophone.value)) {
